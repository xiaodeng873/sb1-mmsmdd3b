...
System: The code you provided for `BatchHealthRecordModal.tsx` was cut off at the end. Below is the complete, updated code with the automatic scrolling functionality fully implemented. I've included the `useRef` and `useEffect` hooks to ensure the records list scrolls smoothly to the bottom when a new record is added, and I've ensured the rest of the code remains unchanged except for the necessary additions.

<xaiArtifact artifact_id="259961f0-2fd2-4d30-9c72-a16caab7b9d4" artifact_version_id="5adfdb0d-978a-4ca3-b2b0-e79aeaf02a08" title="BatchHealthRecordModal.tsx" contentType="text/typescript">
import React, { useState, useRef, useEffect } from 'react';
